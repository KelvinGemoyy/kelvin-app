...
export default function notFound() {
  return (  
    ...
    <div className='flex justify-center items-center h-screen'>
            <svg id="robot"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0" y="0" width="320px" height="300px" viewBox="0 0 160 300" enable-background="new 0 0 320 300" xmlSpace="preserve">
        <rect x="59.722" y="72.779" fill="#333" width="40.557" height="27.564" />
        <g id="head" className={style.head}>
            <g id="leftAntenna" className={style.leftAntenna}>
            ...
            C75.85,13.604,65.745,3.39,53.972,3.39">
                ...
                <ellipse className={style.ellipse} fill="#ccc" cx="55.021" cy="3.39" rx="3.344" ry="3.391">
            ...
            <g id="rightAntenna" className={style.rightAntenna}>
            ...
            C84.15,13.604,94.255,3.39,106.028,3.39">
                ...
                <ellipse className={style.ellipse} fill="#ccc" cx="104.979" cy="3.39" rx="3.344" ry="3.391">
            ...
            <g id='eyeLeft' className={style.eyeLeft}>
                <g id="eyeLeft" className={style.eyeLeft}>
        ...
        <g id="upperTorso" className={style.upperTorso}>
            <g id="eyeLeft">
                <g className={style.eyeLeft}>
            ...
            c-3.827,5.537-6.726,10.938-8.8,16.387c0,0-1.877,4.187,2.599,6.24C16.75,139.75,18.917,135.142,18.917,135.142z" />
                <g>
                    <ellipse className={style.ellipse} stroke="#f54f59" cx="13.581" cy="132.93" rx="8.505" ry="8.623" />
                    <g>
            ...
            <g id="rightArm" className={style.rightArm}>
                <g id='rightArm' className={style.rightArm}>
            ...
            c5.98,4.479,9.323,7.562,13.553,13.761c3.26,4.773,5.697,9.352,7.429,13.925C141.083,135.142,143.25,139.75,148.333,137.417z" />
                <g>
                    <ellipse className={style.ellipse} stroke="#f54f59" cx="146.419" cy="132.93" rx="8.505" ry="8.623" />
                    <g>
        ...
        <g id="lowerTrunk" className={style.lowerTrunk}>
            <g id="leftFoot" className={style.leftFoot}>
                ...
                <g>
                    <ellipse className={style.ellipse} stroke="#f54f59" cx="54.885" cy="200.79" rx="9.294" ry="9.423" />
                    <g>
            ...
            <g id="rightFoot" className={style.rightFoot}>
                ...
                <g id=''>
                    <ellipse className={style.ellipse} stroke="#f54f59" cx="105.115" cy="200.79" rx="9.294" ry="9.423" />
                    <g>
         ...
         <h1  className='text-bold text-[#f54f59] text-9xl flex justify-center items-center h-screen'> 404</h1>
    </>
  ) 
}
